<script>
  ...
  export default {
    ...
    onShow(option) {
      ...
      console.log(option)
      var that = this;
      if(option.path == 'pages/logs/main'||option.path == 'pages/authorize/main'||option.path == 'pages/showPages/main'||option.path == 'pages/index/main'||option.path == 'pages/order/main'||option.path == 'pages/my/main'||option.path == 'pages/myOrder/main'||option.path == 'pages/orderCompletion/main' || option.path == 'pages/refund/main'){
