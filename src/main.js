...
export default {
  ...
  config: {
    ...
    pages: ["^pages/logs/main", "pages/authorize/main", "pages/showPages/main", "pages/index/main", "pages/goods/main", "pages/order/main", "pages/addressSelect/main", "pages/addaddress/main", "pages/my/main", "pages/myOrder/main","pages/orderCompletion/main","pages/refund/main"],
    window: {
