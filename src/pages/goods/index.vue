  ...
  <div class="goods">
    ...
    <div class="goods-info">
      <div class="c">
        ...
        <p><span class="realPrice">￥{{info.retail_price}}</span><span class="virtualPrice">￥{{info.retail_price}}</span><span>￥{{info.retail_price}}</span></p>
...
export default {
  ...
  methods: {
    ...
    async goodsDetail() {
      var that = this;
      wx.request({
        // url: "https://www.heyuhsuo.xyz/heyushuo/goods/detailaction?id="+that.id+"&openId="+that.openId,
